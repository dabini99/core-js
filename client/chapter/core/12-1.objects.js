...
// 제거는 비워두는 것 삭제는 메모리까지 날려버리는 것, 아에 삭제해버리는 것
console.clear()
/* -------------------------------------------------------------------------- */
//객체가 맞는지부터 확인하기
...
function isEmptyObject() {
  ...
  return Object.keys(obj).length === 0 //배열이 나옴
